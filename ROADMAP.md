...
| SCentEx result reporting protocol | 🔬 | Duel results are now persisted and feed the emulator ranking pages, but the exact retail reporting/routing path into the later ranking UI is still unresolved |
